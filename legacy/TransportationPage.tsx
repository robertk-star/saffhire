...
import { ArrowRight, ArrowLeft, FileSearch, Truck, Zap, BadgeCheck, BarChart3, Phone, RefreshCw } from "lucide-react";

const TRANSPORT_IMG = "/images/industry-transportation.webp";
const services = [
  { icon: FileSearch, title: "Criminal Background Checks", description: "Multi-jurisdictional criminal history searches before a driver gets behind the wheel." },
  { icon: Truck, title: "MVR / Driving Record Checks", description: "Motor vehicle record reports from state DMV sources." },
  { icon: Zap, title: "DOT Drug and Alcohol Testing", description: "Pre-employment, random, post-accident, and return-to-duty testing at certified labs." },
  { icon: BadgeCheck, title: "CDL Verification", description: "Verify commercial driver's license class, endorsements, and current status." },
  { icon: BarChart3, title: "Employment Verification", description: "Confirm prior employment history for transportation candidates." },
  { icon: RefreshCw, title: "Ongoing MVR Monitoring", description: "License monitoring for new violations, suspensions, or revocations." },
];
const stats = [
...
export default function TransportationPage() {
  return (
    <div className="min-h-screen bg-white">
      <PageSEO path="/industries/transportation" title="Background Screening for Transportation Companies" description="Driver and transportation background screening including MVR checks, drug testing, and criminal history with FCRA-compliant screening workflows." />
      <Navbar />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 min-h-[520px]">
            <div className="flex flex-col justify-center py-16 pr-0 lg:pr-12">
              ...
              <p className="text-gray-300 text-lg leading-relaxed mb-8 max-w-lg">Driver screening built for trucking companies, logistics providers, and fleet operators, with FCRA-compliant screening workflows.</p>
