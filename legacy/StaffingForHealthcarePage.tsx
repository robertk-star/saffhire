...
const features = [
  { icon: Users, title: "Specialty Healthcare Recruiting", description: "Medical facilities, dentistry, behavioral health, and vision segments." },
  { icon: Zap, title: "Flexible Staffing Solutions", description: "Temporary coverage and permanent placements when you need them." },
  { icon: BarChart3, title: "Human Capital & Back-Office Solutions", description: "PEO alternatives, Employer of Record, and payroll support." },
  { icon: Shield, title: "30+ Years of Ownership Experience", description: "Healthcare business challenges viewed from the owner's side of the table." },
];
      ...
      <section className="pt-20" style={{ backgroundColor: "#0f172a" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="inline-block text-xs font-bold uppercase tracking-widest mb-4 px-3 py-1 rounded-full" style={{ backgroundColor: "rgba(34,197,94,0.15)", color: "#22c55e", fontFamily: "'Montserrat', sans-serif" }}>Healthcare Staffing</span>
              <h1 className="text-4xl lg:text-5xl font-black text-white mb-4 leading-tight" style={{ fontFamily: "'Montserrat', sans-serif" }}>Staffing for Healthcare</h1>
              <p className="text-lg font-semibold mb-5" style={{ color: "#22c55e", fontFamily: "'Montserrat', sans-serif" }}>We Keep You Smiling!</p>
              <p className="text-gray-300 leading-relaxed mb-8 max-w-lg">Staffing for Healthcare helps healthcare business owners solve people problems and grow profitably.</p>
            ...
            <div className="flex items-center justify-center">
              <div className="rounded-2xl p-12 flex items-center justify-center shadow-2xl" style={{ backgroundColor: "#ffffff", width: "100%", maxWidth: 420, minHeight: 220 }}>
                <img src={STAFFING_FOR_HEALTHCARE_LOGO} alt="Staffing for Healthcare logo" className="max-h-20 max-w-full object-contain" />
              </div>
            </div>
          </div>
        </div>
