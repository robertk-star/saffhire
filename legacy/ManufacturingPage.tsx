...
import { ArrowRight, ArrowLeft, FileSearch, Zap, BadgeCheck, BarChart3, Phone, RefreshCw, Package } from "lucide-react";

const MFG_IMG = "/images/industry-manufacturing.webp";
const services = [
  { icon: FileSearch, title: "Criminal Background Checks", description: "Multi-jurisdictional criminal history searches before a worker enters your facility." },
  ...
  { icon: BarChart3, title: "Education and Credential Verification", description: "Verify degrees, certifications, and trade licenses." },
  { icon: RefreshCw, title: "Ongoing Workforce Monitoring", description: "Continuous criminal monitoring between review cycles." },
  { icon: Package, title: "Contractor and Vendor Screening", description: "Screen contractors, temp workers, and vendors who access your facility." },
];
const stats = [
...
export default function ManufacturingPage() {
  return (
    <div className="min-h-screen bg-white">
      <PageSEO path="/industries/manufacturing" title="Background Screening for Manufacturing Companies" description="Background screening for warehouse, logistics, and manufacturing companies with FCRA-compliant screening workflows." />
      <Navbar />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 min-h-[520px]">
            <div className="flex flex-col justify-center py-16 pr-0 lg:pr-12">
              ...
              <p className="text-gray-300 text-lg leading-relaxed mb-8 max-w-lg">Fast, FCRA-compliant screening workflows built for high-volume industrial employers.</p>
