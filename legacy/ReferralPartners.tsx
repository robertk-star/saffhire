...
const BENEFITSME_LOGO = "/images/partner-benefitsme.svg";
...
const FYNN_LOGO = "/images/partner-fynn.svg";
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-20" style={{ backgroundColor: "#0f172a" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6 text-sm font-bold" style={{ backgroundColor: "rgba(34,197,94,0.15)", color: "#22c55e", fontFamily: "'Montserrat', sans-serif" }}>
            <HandshakeIcon size={14} />
            TRUSTED PARTNERS
          </div>
          <h1 className="text-4xl lg:text-5xl font-black text-white mb-5" style={{ fontFamily: "'Montserrat', sans-serif" }}>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {partners.map((partner) => (
              <div key={partner.slug} className="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-lg hover:border-green-200 transition-all duration-300 overflow-hidden group flex flex-col">
                ...
                <div className="p-7 flex flex-col flex-1">
                  <span className="inline-block text-xs font-bold uppercase tracking-widest mb-3 px-3 py-1 rounded-full" style={{ backgroundColor: "#f0fdf4", color: "#16a34a", fontFamily: "'Montserrat', sans-serif" }}>
                    {partner.category}
                  </span>
                  <h2 className="text-xl font-black text-gray-900 mb-1" style={{ fontFamily: "'Montserrat', sans-serif" }}>{partner.name}</h2>
                  <p className="text-sm font-semibold mb-4" style={{ color: "#22c55e" }}>{partner.tagline}</p>
                  <p className="text-gray-500 text-sm leading-relaxed flex-1">{partner.description}</p>
                  <div className="flex items-center gap-3 mt-6 pt-5 border-t border-gray-100">
                    <a href={`/referral-partners/${partner.slug}`} className="btn-green inline-flex items-center gap-2 px-5 py-2.5 rounded-sm font-bold text-sm flex-1 justify-center" style={{ fontFamily: "'Montserrat', sans-serif" }}>
            ...
            <div className="rounded-2xl border-2 border-dashed border-gray-200 flex flex-col items-center justify-center p-10 text-center" style={{ minHeight: 340 }}>
              ...
              <p className="font-bold text-gray-400 mb-2" style={{ fontFamily: "'Montserrat', sans-serif" }}>More Partners Coming Soon</p>
              <p className="text-gray-400 text-sm leading-relaxed max-w-xs">We are continually expanding our network of trusted referral partners.</p>
            </div>
          </div>
        </div>
      </section>
      <section className="py-20" style={{ backgroundColor: "#f8fafc" }}>
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl lg:text-3xl font-black text-gray-900 mb-4" style={{ fontFamily: "'Montserrat', sans-serif" }}>Interested in Becoming a Referral Partner?</h2>
          <p className="text-gray-600 leading-relaxed mb-8">If your business serves employers and their teams, we would love to explore a partnership. Reach out to the SaffHire team to learn more about our referral partner program.</p>
          <a href="/#contact" className="btn-green inline-flex items-center gap-2 px-8 py-4 rounded-sm font-bold" style={{ fontFamily: "'Montserrat', sans-serif" }}>Contact Us <ArrowRight size={16} /></a>
        </div>
      </section>
      <Footer />
    </div>
