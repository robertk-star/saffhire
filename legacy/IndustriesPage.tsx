/*
 * IndustriesPage - Standalone /industries route
 * Lists all industry verticals with links to dedicated industry pages.
...
const industries = [
  {
    ...
    image:
      "https://d2xsxph8kpxj0f.cloudfront.net/310519663368468239/Ge2emXXoKVgq4kYU9oXE74/healthcare-hospital-TqNkSFgkDmXDEfxrEshCw.webp",
  },
  {
    name: "Staffing",
    ...
    image:
      "https://d2xsxph8kpxj0f.cloudfront.net/310519663368468239/Ge2emXXoKVgq4kYU9oXE74/staffing-agency-9RXkLmPqWvYtBnCdFjHsA2.webp",
  },
  {
    name: "Transportation",
    ...
    image:
      "https://d2xsxph8kpxj0f.cloudfront.net/310519663368468239/Ge2emXXoKVgq4kYU9oXE74/transportation-driver-KpLmNqRsTuVwXyZaB3C4D.webp",
  },
  {
    name: "Manufacturing",
      ...
      <section className="pt-32 pb-16" style={{ backgroundColor: "#0f172a" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto text-lg leading-relaxed">
            SaffHire serves organizations across 8 industries with tailored, FCRA-compliant
      ...
      <section className="py-16" style={{ backgroundColor: "#0f172a" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-400 mb-8 max-w-xl mx-auto">
            We work with businesses across all sectors. Contact us and we'll build a custom
