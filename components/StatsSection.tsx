/*
 * StatsSection Component SaffHire Background Screening
 * Design: Clean white section with large stat numbers and dividers
 */

export default function StatsSection() {
  const stats = [
    { number: "5+", label: "Years of Success", description: "Giving your business the tools and data it needs to make the best hire every time." },
    { number: "98%", label: "Client Satisfaction", description: "Our clients consistently rate us highly for speed, accuracy, and customer service." },
