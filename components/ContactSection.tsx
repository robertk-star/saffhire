...
export default function ContactSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(result.error || "The form could not be submitted. Please call SaffHire at 888-588-1733.");
      }
      ...
      setErrorMessage(error instanceof Error ? error.message : "The form could not be submitted. Please call SaffHire at 888-588-1733.");
    } finally {
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-bold text-gray-900 text-sm mb-1" style={{ fontFamily: "'Montserrat', sans-serif" }}>Service Area</p>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
              {submitted ? (
                <div className="flex flex-col items-center justify-center h-full py-12 text-center">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-2" style={{ fontFamily: "'Montserrat', sans-serif" }}>Message Sent!</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-5" data-form="contact" data-conversion="contact_form_submit">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input type="text" required value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} className="w-full border border-gray-200 rounded-sm px-4 py-2.5 text-sm focus:outline-none focus:border-green-500 transition-colors" placeholder="John Smith" />
                    </div>
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-1.5" style={{ fontFamily: "'Montserrat', sans-serif" }}>Email *</label>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input type="text" value={formData.company} onChange={(e) => setFormData({ ...formData, company: e.target.value })} className="w-full border border-gray-200 rounded-sm px-4 py-2.5 text-sm focus:outline-none focus:border-green-500 transition-colors" placeholder="Your Company" />
                    </div>
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-1.5" style={{ fontFamily: "'Montserrat', sans-serif" }}>Phone</label>
