      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <nav className="hidden lg:flex items-center gap-8">
            ...
            <a href="/services" className="text-gray-700 hover:text-green-600 font-medium text-sm transition-colors">
              Services
            </a>
            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 mt-0 w-56 bg-white shadow-lg rounded-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 py-2 max-h-96 overflow-y-auto">
                {industryItems.map((item) => (
                  <a key={item.label} href={item.href} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-green-600">
                    {item.label}
                  </a>
                ))}
              </div>
          ...
          <div className="hidden lg:flex items-center gap-4">
            <button className="p-2 text-gray-500 hover:text-green-600 transition-colors" aria-label="Search">
              <Search size={18} />
            </button>
            <a href="https://saffhire.instascreen.net/sso/login.taz" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-green-600 font-medium text-sm transition-colors">
              Login
            </a>
            <a href="https://intake.saffhire.com/" target="_blank" rel="noopener noreferrer" className="bg-green-500 hover:bg-green-600 text-white font-medium text-sm px-5 py-2 rounded-md transition-colors">
              Create Account
            </a>
            <a href="/contact" className="bg-green-500 hover:bg-green-600 text-white font-medium text-sm px-5 py-2 rounded-md transition-colors">
              Get Quote
            </a>
          </div>
      ...
      {mobileOpen && (
        <div className="lg:hidden bg-white border-t border-gray-100 shadow-lg">
          <div className="px-4 py-4 space-y-3">
            <a href="/why-saffhire" className="block py-2 text-sm font-semibold text-gray-700 hover:text-green-600 transition-colors" onClick={() => setMobileOpen(false)}>
              Why SaffHire
            </a>
            <a href="/services" className="block py-2 text-sm font-semibold text-gray-700 hover:text-green-600 transition-colors" onClick={() => setMobileOpen(false)}>
              Services
            </a>
            ...
            <div>
              ...
              {servicesOpen && (
                <div className="pl-4 space-y-2 mt-2">
                  {industryItems.map((item) => (
                    <a key={item.label} href={item.href} className="block py-1 text-sm text-gray-600 hover:text-green-600 transition-colors" onClick={() => setMobileOpen(false)}>
                      {item.label}
                    </a>
                  ))}
                </div>
            ...
            <a href="/referral-partners" className="block py-2 text-sm font-semibold text-gray-700 hover:text-green-600 transition-colors" onClick={() => setMobileOpen(false)}>
              Partners
            </a>

            <div className="pt-4 space-y-2 border-t border-gray-200">
              <a href="https://saffhire.instascreen.net/sso/login.taz" target="_blank" rel="noopener noreferrer" className="block py-2 text-sm font-semibold text-gray-700 hover:text-green-600 transition-colors" onClick={() => setMobileOpen(false)}>
                Login
              </a>
              <a href="https://intake.saffhire.com/" target="_blank" rel="noopener noreferrer" className="block bg-green-500 hover:bg-green-600 text-white text-center font-semibold text-sm py-2 rounded-md transition-colors" onClick={() => setMobileOpen(false)}>
                Create Account
              </a>
